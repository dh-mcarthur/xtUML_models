 ...
 */
#define GPSWatch_Unit__UNINITIALIZED__e -1
#define GPSWatch_Unit_km_e 0
#define GPSWatch_Unit_meters_e 1
#define GPSWatch_Unit_minPerKm_e 2
#define GPSWatch_Unit_kmPerHour_e 3
#define GPSWatch_Unit_miles_e 4
#define GPSWatch_Unit_yards_e 5
#define GPSWatch_Unit_feet_e 6
#define GPSWatch_Unit_minPerMile_e 7
#define GPSWatch_Unit_mph_e 8
#define GPSWatch_Unit_bpm_e 9
#define GPSWatch_Unit_laps_e 10
