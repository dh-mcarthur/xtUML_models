...
struct HeartRateMonitor_HeartRateMonitor {
  ...
  r4_t recentHeartRate;  /* - recentHeartRate */
...
/*
 * class-based event:  HeartRateMonitor_A1:'registerListener'
 */
typedef struct {
...
/*
 * class-based event:  HeartRateMonitor_A2:'unregisterListener'
 */
typedef struct {
  EVENT_BASE_ATTRIBUTE_LIST         /* base attributes of all event classes */
  /* Note:  no supplemental data for this event */
...
#define HEARTRATEMONITOR_HEARTRATEMONITOR_CBEVENT1NUM 1  /* HeartRateMonitor_A1:'registerListener' */
#define HEARTRATEMONITOR_HEARTRATEMONITOR_CBEVENT2NUM 2  /* HeartRateMonitor_A2:'unregisterListener' */
