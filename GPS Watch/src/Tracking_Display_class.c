...
{
  r4_t distance; Tracking_TrackLog * trackLog; 
  /* ASSIGN distance = 0.0 */
...
{
  r4_t speed; Tracking_TrackLog * trackLog; 
  /* ASSIGN speed = 0.0 */
...
{
  r4_t pace; Tracking_TrackLog * trackLog; 
  /* ASSIGN pace = 0.0 */
...
{
  r4_t heartRate; Tracking_TrackLog * trackLog; 
