...
void Tracking_TrackLog_op_addHeartRateSample( Tracking_TrackLog *, r4_t );
void Tracking_TrackLog_op_clearHeartRateSamples( Tracking_TrackLog * );
void Tracking_TrackLog_op_init( Tracking_TrackLog * );

extern void Tracking_TrackLog_R1_Link( Tracking_TrackPoint *, Tracking_TrackLog * );
extern void Tracking_TrackLog_R1_Unlink( Tracking_TrackPoint *, Tracking_TrackLog * );
