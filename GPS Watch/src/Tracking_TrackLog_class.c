...
Tracking_TrackLog_op_addTrackPoint( Tracking_TrackLog * self, GPSWatch_sdt_Location p_location)
{
 ...
 r4_t distance; 
  ...
  workoutTimer = self->WorkoutTimer_R4;
...
Tracking_TrackLog_op_clearTrackPoints( Tracking_TrackLog * self)
{
 ...
 Tracking_TrackPoint * lastPoint = 0; /* lastPoint (TrackPoint) */
  ...
  while ( !( 0 == nextPoint ) ) {
    ...
    nextPoint = nextPoint->TrackPoint_R2_follows;
...
Tracking_TrackLog_op_clearLapMarkers( Tracking_TrackLog * self)
{
 ...
 Tracking_LapMarker * lapMarker; 
  ...
  Escher_IteratorReset( &iter1, lapMarkers );
  while ( (Tracking_LapMarkeriter1 = (Tracking_LapMarker *)Escher_IteratorNext( &iter1 )) != 0 ) {
    lapMarker = Tracking_LapMarkeriter1; {
 ...
 */
void
Tracking_TrackLog_op_addHeartRateSample( Tracking_TrackLog * self, r4_t p_heartRate)
{
...
Tracking_TrackLog_op_clearHeartRateSamples( Tracking_TrackLog * self)
{
 ...
 Tracking_HeartRateSample * sample; 
  ...
  Escher_IteratorReset( &iter2, samples );
  while ( (Tracking_HeartRateSampleiter2 = (Tracking_HeartRateSample *)Escher_IteratorNext( &iter2 )) != 0 ) {
    sample = Tracking_HeartRateSampleiter2; {
