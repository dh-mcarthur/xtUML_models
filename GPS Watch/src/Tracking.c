 ...
 */
void
Tracking_HR_heartRateChanged( r4_t p_heartRate)
{
 ...
 */
void
Tracking_UI_setTime( i_t p_time)
{
 ...
 */
void
Tracking_UI_setData( s2_t p_unit, r4_t p_value)
{
...
{
  Tracking_WorkoutTimer * workoutTimer; 
