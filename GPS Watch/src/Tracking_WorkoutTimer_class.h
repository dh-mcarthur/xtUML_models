...
extern void Tracking_WorkoutTimer_R4_Link( Tracking_TrackLog *, Tracking_WorkoutTimer * );
extern void Tracking_WorkoutTimer_R4_Unlink( Tracking_TrackLog *, Tracking_WorkoutTimer * );
